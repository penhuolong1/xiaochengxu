...
Page({
  ...
  data: {
    ...
    nomalPeople: {
      ...
      litigationStatus: 3, //诉讼地位：1.原告；2.被告；3.第三人；4.申请人；5.被申请人
      name: '', //当事人姓名
      identityCard: "", //身份证号
      sex: "", //性别0.男；1.女
    ...
    selectLitigant(id).then(res => {
      if (res.state == 100) {
        ...
        if (info.identityType == 1) {
          ...
          this.setData({
            roleType: '法人',
            [name]: info.litigantName,
            [identityCard]: info.identityCard,
            [litigantPhone]: info.litigantPhone,
            [address]: info.address,
            [employer]: info.employer,
            [legalManName]: info.legalManName,
            [legalManPhone]: info.legalManPhone,
            [legalManId]: info.legalManId,
          })
        }
      }
    })
